...
> [!TIP]
> **Definining gates with the DSL**
>
> You can also define custom parametric gates using the [`@gatedecl`](@ref) macro. See the [Circuit DSL](dsl.md#Gate-Declarations) page for more details.
