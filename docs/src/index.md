...
!!! note "MIMIQ Platform"
    **The World’s Most Powerful Virtual Quantum Computer.**
    Build, simulate, and optimize quantum circuits with industry-leading statevector and tensor network emulators.

## Quick Links

- **[Getting Started](quick_start/)**: Installation guide and a high-level overview of the library's capabilities.
- **[Core Concepts](manual/circuits/)**: Learn about Circuits, Hamiltonians, and the fundamental building blocks.
- **[Operations](manual/unitary_gates/)**: Explore the vast library of quantum gates, noise models, and measurements.
- **[Simulation](manual/simulation/)**: Run exact local simulations or submit large-scale jobs to the QPerfect cloud.
...
If you encounter any issues using MIMIQ take a look at the "Performance Tips and Common Issues" section, or contact us at [QPerfect](https://qperfect.io/#contact). Finally for more in depth explanation of the different functions available you can head to the **API Reference** section.

## Resources

- [MIMIQ Product Page](https://qperfect.io/index.php/mimiq/)
- [Contact QPerfect](https://qperfect.io/#contact)
- [GitHub Repository](https://github.com/qperfect-io/MimiqCircuits.jl)
